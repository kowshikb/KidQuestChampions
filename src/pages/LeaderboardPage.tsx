...
const LeaderboardPage: React.FC = () => {
  ...
  const getFilterName = () => {
    switch (activeFilter) {
      case 'global': return 'Global Heroes';
      case 'country': return 'My Kingdom';
      case 'state': return 'My Village';
      case 'city': return 'My Neighborhood';
      case 'friends': return 'My Alliance';
    }
  };
      ...
      >
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-bold text-purple-900 mb-2">No Champions Found</h3>
            ...
            <table className="min-w-full">
              <thead>
                <tr className="bg-purple-50">
                  <th className="py-3 px-4 text-left text-sm font-medium text-purple-900">Rank</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-purple-900">Champion</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-purple-900">User ID</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-purple-900">Location</th>
                  <th className="py-3 px-4 text-right text-sm font-medium text-purple-900">Coins</th>
                </tr>
              </thead>
                  ...
                  return (
                    ...
                    >
                      <td className="py-4 px-4">
                        <div className="flex items-center">
                          <span className="font-medium text-purple-900 mr-2">{index + 1}</span>
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center">
                          ...
                          <span className={`font-medium ${isCurrentUser ? 'text-purple-700' : 'text-gray-900'}`}>
                            {user.username}
                            {isCurrentUser && <span className="ml-2 text-purple-500">(You)</span>}
                          </span>
                        </div>
                      </td>
