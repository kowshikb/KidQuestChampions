...
import { User, Edit, CheckCircle, LogOut, Coins as Coin, Award, Users } from 'lucide-react';
      ...
      <div className="grid md:grid-cols-3 gap-8">
                      ...
                      {AVATAR_OPTIONS.map((avatar, index) => (
                        <div 
                          ...
                          className={`cursor-pointer rounded-lg overflow-hidden border-2 transition-all ${
                            avatarUrl === avatar ? 'border-purple-500 shadow-md' : 'border-gray-200 hover:border-purple-300'
                          }`}
                          onClick={() => {
                            setAvatarUrl(avatar);
                            playSound('click');
                ...
                <div>
                  <div className="flex flex-col md:flex-row items-center md:items-start">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <h3 className="text-2xl font-bold text-purple-900 mb-1">{userProfile.username}</h3>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-purple-50 p-3 rounded-xl text-center">
                          ...
                          <div className="font-bold text-purple-900 text-xl">{userProfile.coins}</div>
                        </div>
                        <div className="bg-purple-50 p-3 rounded-xl text-center">
                          <div className="text-sm text-purple-600 mb-1">Quests</div>
                          <div className="font-bold text-purple-900 text-xl">{userProfile.completedTasks?.length || 0}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    <div className="mb-2 flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium text-purple-600">{getProfileCompletionPercentage()}%</span>
                    </div>
                  ...
                  <div className="mt-6">
                    <p className="text-gray-600 mb-2">User ID (Share with friends to connect):</p>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md overflow-hidden border-2 border-purple-100">
              <div className="p-6">
                <h3 className="text-lg font-bold text-purple-900 mb-4">Adventure Stats</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-3 bg-purple-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-purple-900">{userProfile.coins}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-green-50 rounded-xl">
                    ...
                    <div>
                      <div className="text-sm text-green-600">Quests Completed</div>
                      <div className="font-bold text-green-900">{userProfile.completedTasks?.length || 0}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-yellow-50 rounded-xl">
                    ...
                    <div>
                      <div className="text-sm text-yellow-600">Leaderboard Rank</div>
                  ...
                  <div className="flex items-center p-3 bg-blue-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-blue-900">{userProfile.friendsList?.length || 0}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl shadow-md overflow-hidden text-white p-6">
              ...
              <p className="mb-4 opacity-90">Exciting new features are on the way:</p>
